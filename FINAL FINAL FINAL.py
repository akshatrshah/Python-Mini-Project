...
def reviving_data():
    with open("Customer_name.txt", "r") as f:

        for line in f:
            stripped_line = line.rstrip()
            customerNames.append(stripped_line)
    with open("Customer_num.txt", "r") as f:
        for line in f:
            stripped_line = line.rstrip()
            customerNum.append(int(stripped_line))
    with open("Customer_pins.txt", "r") as f:
        for line in f:
            stripped_line = line.rstrip()
            customerPins.append(stripped_line)
    with open("Customer_balance.txt", "r") as f:
        for line in f:
            stripped_line = line.rstrip()
            customerBalances.append(int(stripped_line))
    with open("Customer_loan.txt", "r") as f:
        for line in f:
            stripped_line = line.rstrip()
            customerLoans.append(int(stripped_line))


def updating_data():
    file = open('Customer_name.txt')
    file.close()
    with open("Customer_name.txt", "w+") as k:

        for i in customerNames:
            k.write(f'{i}\n')
    with open("Customer_num.txt", "w+") as k:

        for i in (customerNum):
            k.write(f'{i}\n')

    with open("Customer_pins.txt", "w+") as k:

        for i in customerPins:
            k.write(f'{i}\n')

    with open("Customer_balance.txt", "w+") as k:

        for i in customerBalances:
            k.write(f'{i}\n')

    with open("Customer_loan.txt", "w+") as k:

        for i in customerLoans:
            k.write(f'{i}\n')
...
class my_bank():
        ...
        while True:
            ...
            if a in customerNum:
                ...
                if passcode == customerPins[x]:
                    if amount <= customerBalances[x] and amount>0:
                        ...
                        while True:
                            speak('Do you want a written statement for withdrawal, enter Y or N:')
                            xyz = input("Do you want a written statement for withdrawal, enter Y/N: ")
                            if xyz.lower() == "y":
                                o = datetime.datetime.now()
                        ...
                        print(colored("Insufficient balance OR invalid amount", 'red'))
                        speak("Insufficient balance OR Invalid amount")
                        break
                else:
        ...
        while True:
            ...
            if a in customerNum:
                ...
                if amount > 0:
                    ...
                    print(colored("Please enter a valid amount. ", "red"))
    ...
    def loan(self):
        ...
        print(
            "->  Time for repaying the loan will be as per your requirement and accordingly EMIs will be calculated. ")
        print(
        ...
        speak(
            '1. We offer a loan to all our customers at a rate of interest of 6% , 2. Time for repaying the loan will be as per your requirement and accordingly E M eyes will be calculated,'
                ...
                if loan_amount > 0:
                    ...
                    if passcode == customerPins[x]:
                        ...
                        if l < customerBalances[x]:
                            ...
                            print(f"Each installment will be of:{l}")
                            speak(f"Each installment will be of:{l}")
                            ...
                            while True:
                                speak("Do you want a written statement for loan, enter Y or N: ")
                                xyz = input("Do you want a written statement for , enter Y/N: ")
                                if xyz.lower() == "y":
                                    o = datetime.datetime.now()
                    ...
                    print(colored("Please Enter valid Loan Amount."))
                    speak("Please Enter valid Loan Amount.")
            else:
                print(colored("Enter valid account number. ", "red"))
                speak("Enter valid account number. ")
                print(colored("No account with the given account number exists with us. ", "red"))
    ...
    def overseas_transfers(self):
        ...
        speak(
            '1.  We levy a transaction fees of 2 percent on overseas transfer, 2. Transaction time will be around 1-2 hours depending on the server load, please be patient'
            ...
            if a in customerNum:
                ...
                if passcode == customerPins[x]:
                    if transferoff < customerBalances[x]:
                        ...
                        while True:
                            speak("Do you want a written statement for overseas transfer, enter Y or N")
                            xyz = input("Do you want a written statement for overseas transfer, enter Y/N: ")
                            if xyz.lower() == "y":
                                o = datetime.datetime.now()
                                n = f'         ----The India Bank---- \n\n                             {o}\n\n\nFor Account Number {customerNum[x]} an overseas transfer to {internationalacc} at {namebank},{country} was executed.\n\n\n----Thank you for banking with us!----'
                                bill_generator(n)
                                break
                            elif xyz.lower() == "n":
                                print("Thank you for banking with us!")
                ...
                if passcode == customerPins[x]:
                    ...
                    if c in customerNum:
                        ...
                        if v > 0:
                            ...
                            print(colored('Please enter valid amount. ', 'red'))
                            speak('Please enter valid amount. ')
                    else:
                ...
                if passcode == customerPins[x]:
                    if customerLoans[x] > 0:
                        ...
                        if f == 1:
                            ...
                            if customerBalances[x] >= amount > 0 and amount <=customerLoans[x]:
                                customerBalances[x] = customerBalances[x] - amount
                                ...
                                print(colored("Insufficent Balance OR invalid amount" , "red"))
                                speak('insufficient balance OR invalid amount')
                                break
                        else:
                            print('exiting......')
...
if __name__ == '__main__':
    ...
    def listen():
        ...
        try:
            ...
            print('Error code 609, please say Hey Banker to start the system')
